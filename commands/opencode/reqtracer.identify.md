---
description: Scan specification files and identify requirements with unique REQ IDs
agent: general
---
...
- Create `.reqtracer/config.json` with confirmed directories (version: "1.0", aiTool: "opencode")
